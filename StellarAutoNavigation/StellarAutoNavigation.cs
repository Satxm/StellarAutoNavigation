...
{
    public class StellarAutoNavigation
    {
        ...
        public StellarAutoNavigation(NavigationConfig config)
        {
            this.config = config;
        ...
        public static class Warp
        {
            ...
            public static bool TryWrap(StellarAutoNavigation self, PlayerMove_Sail __instance)
            {
            ...
            public static bool HasWarpChance(StellarAutoNavigation self, PlayerMove_Sail __instance)
            {
                if (__instance.player.mecha.thrusterLevel < THRUSTER_LEVEL_WARP)
                    return false;
        ...
        public static class Sail
        {
            ...
            public static void TrySpeedUp(StellarAutoNavigation __this, PlayerMove_Sail __instance)
            {
